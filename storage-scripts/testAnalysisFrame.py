...
try:
    ...
    # resp = requests.post("https://edusense-dev-1.arafat.ahut.edu:9000/analytics",
    #                         headers=backend_params['headers'],
    #                         json={'analytics': analytics_schema})

    # Query
    req = {'query': query}
    resp = requests.post("https://edusense-dev-1.arafat.ahut.edu:9000/query", headers=backend_params['headers'], json=req)
